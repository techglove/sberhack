...
def list_news():
    news = {
        'news': [{
                ...
                'text': 'С 14 декабря власти Москвы расширяют список лиц, которые могут сделать прививку от COVID-19. Как объявил мэр Москвы Сергей Собянин, вакцинироваться смогут «работники МФЦ, культуры, а также работники торговли и услуг». \n«По роду своей работы они контактируют с миллионами граждан, рискуют сами, а в случае заболевания представляют угрозу для окружающих», — сообщается на сайте Собянина.',
            ...
            },
            {
                ...
                'text': 'В России за прошедшие сутки зарегистрированы 28 137 новых случаев заражения коронавирусной инфекцией, сообщает оперативный штаб по борьбе с вирусом. Это на 448 случаев меньше, чем днем ранее.\nБольше всего заболевших в Москве (+6622 случая за сутки), Петербурге (+3776) и Подмосковье (+1393). Общее число инфицированных в стране достигло 2 625 848 человек.\nЗа сутки от коронавируса умерли 560 человек, за все время с начала пандемии, по данным оперативного штаба, — 46 453 человека.\nВыздоровели в общей сложности 2 085 958 человек, в том числе 26 118 пациентов выписаны из больниц за минувший день.',
            ...
            },
            {
                ...
                'text': 'Управление по санитарному надзору за качеством пищевых продуктов и медикаментов (FDA) США одобрило использование в стране вакцины от COVID-19, произведенной американской компанией Pfizer и немецкой BioNTech. Об этом говорится в сообщении управления. \nВакцинироваться смогут люди от 16 лет. Как отмечает CNN, в ближайшие недели в США могут привить от коронавируса примерно 20 млн человек. Президент США Дональд Трамп заявил, что вакцинация начнется не менее чем через 24 часа. «Мы создали безопасную и эффективную вакцину всего за девять месяцев. Это одно из величайших научных достижений в истории», — сказал он',
            ...
            },
            {
                ...
                'text': 'Сбербанк провел исследование и выявил пять групп людей, наиболее подверженных риску заражения коронавирусом. Среди них оказались те, кто оплачивает ЖКХ с помощью квитанций, рассказал в ходе конференции по искусственному интеллекту AI Journey первый заместитель председателя Сбербанка Александр Ведяхин.\n«Первые люди, максимально подверженные риску ковида, вот прям с огромным отрывом, — это люди, которые пользуются наличными денежными средствами. Вторая категория — это если человек платит с помощью квитанции ЖКХ. Все, что связано с наличными деньгами, наличными квитанциями и так далее — это все сильно увеличивает риск заболевания», — пояснил он.\nТакже, по словам Ведяхина, риску заражения подвержены люди, которые активнее большинства используют общественный транспорт. Кроме того, в Сбербанке выяснили, что частое использование каршеринга и такси также увеличивает шансы заболеть.\nВдобавок в ходе исследования выяснилось, что заражению подвержены люди, в большом количестве покупающие лотерейные билеты. Ведяхин разъяснил, что это опять же связано с использованием бумажных носителей.',
